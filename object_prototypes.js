...
var firstUser = new User('khrist', 'yohan', 32, 'vellore');
...
console.log(
  '////////////// CANT ADD PROPERTIES TO A PROTOTYPE THRO THIS WAY //////////////////'
);
...
User.prototype.nationality = 'Indian'; // indian default value
...
var secondUser = new User('khrist', 'yohan', 27, 'Vellore');
